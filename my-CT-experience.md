...
2) At server side: continuing from last step of first part above, when following the instructions to create a `"actions-runner"` folder, the folder can be named anything. For me I name it within an `"automated-repos"` folder, and name the actions runner folder using the project name.
   Then:
